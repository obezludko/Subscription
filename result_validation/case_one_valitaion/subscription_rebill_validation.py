...
if select_second_rebill_is_payout_received() == second_rebill_check_key_value():
    print('second rebill is_payout_received true')
else:
    print('second rebill is_payout_received false')
...
if select_third_rebill_is_payout_received() == third_rebill_check_key_value():
    print('third rebill is_payout_received true')
else:
    print('third rebill is_payout_received false')
